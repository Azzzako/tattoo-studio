...
describe('duration', () => {
  ...
  it('detects overlap', () => {
    expect(rangesOverlap('2026-01-01T12:00:00.000Z', '2026-01-01T13:00:00.000Z',
      '2026-01-01T12:30:00.000Z', '2026-01-01T13:30:00.000Z')).toBe(true);
  });

  it('detects disjoint ranges', () => {
    expect(rangesOverlap('2026-01-01T12:00:00.000Z', '2026-01-01T13:00:00.000Z',
      '2026-01-01T13:00:00.000Z', '2026-01-01T14:00:00.000Z')).toBe(false);
  });
});